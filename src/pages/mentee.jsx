...
function Mentee () {
    return (
        <>  
            ...
            <div className="mentor-card-item" id="meen1">
                ...
                <div className="mentor-card">
                    <img className="menn1 meen-img" src="/images/mentee-2.png" alt="" />
                    <div className="mentor-card-text">
                        <h2>Artist</h2>
                ...
                <div className="mentor-card" id="iof meeen">
                    <img className="menn2 meen-img2" src="/images/mentee-3.png" alt="" />
                    <div className="mentor-card-text">
            ...
            <div className="mentor-card-item" id="meen1">
                ...
                <div className="mentor-card">
                    <img className=" meen-img" src="/images/mentee-5.png" alt="" />
                    <div className="mentor-card-text">
                        <h2>Artist</h2>
                        <h3>Dina Malkawi</h3>
                ...
                <div className="mentor-card" id="iof">
                    <img className="menn2 meen-img2" src="/images/mentee-6.png" alt="" />
                    <div className="mentor-card-text">
            ...
            <div className="mentor-card-item m1" id="meen1">
                <div className="mentor-card">
                    <img src="/images/mentee-7.png" alt="" />
                    <div className="mentor-card-text" id="meen1-text">
                ...
                <div className="mentor-card" id="mm">
                    <img className="menn1 meen-img" src="/images/mentee-8.png" alt="" id="hann"/>
                    <div className="mentor-card-text">
                        <h2>Artist</h2>
                ...
                <div className="mentor-card of" id="iof">
                    <img className="menn2 meen-img2" src="/images/mentee-9.png" alt=""/>
                    <div className="mentor-card-text">
                        <h2>Artist</h2>
                        <h3>Tina Omran</h3>
